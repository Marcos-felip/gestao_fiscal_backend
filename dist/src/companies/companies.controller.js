...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all companies for the current user' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Onboard company with CNPJ, tax regime and MATRIZ establishment' }),
    (0, swagger_1.ApiResponse)({ status: 200 }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, tenant_protected_decorator_1.TenantProtected)(client_1.MembershipRole.OWNER),
    (0, swagger_1.ApiOperation)({ summary: 'Update a company (OWNER only)' }),
    (0, swagger_1.ApiResponse)({ status: 200 }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_company_decorator_1.CurrentCompany)()),
