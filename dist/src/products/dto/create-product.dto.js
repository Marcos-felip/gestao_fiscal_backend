...
class CreateProductDto {
    ...
    sku;
    barcode;
    unit = client_1.UnitOfMeasure.UN;
    costPrice;
    salePrice;
    minStock;
    ncm;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.UnitOfMeasure, default: client_1.UnitOfMeasure.UN }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(client_1.UnitOfMeasure),
    __metadata("design:type", String)
