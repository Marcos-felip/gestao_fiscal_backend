...
const company_tenant_guard_1 = require("../common/guards/company-tenant.guard");
...
exports.MembershipsModule = MembershipsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [memberships_service_1.MembershipsService, company_tenant_guard_1.CompanyTenantGuard, roles_guard_1.RolesGuard],
