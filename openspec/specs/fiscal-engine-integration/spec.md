...
Manter o domínio fiscal do NestJS agnóstico ao motor de emissão por meio da porta
`IFiscalEngine`, com implementação concreta que delega a montagem/assinatura/
transmissão do XML a um microserviço .NET stateless (DFe.NET).
