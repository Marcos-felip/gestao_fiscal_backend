...
- [x] 9.6 **Numeração queimada em falha de criação — resolvido pela etapa 4 em 14/08/2026.** A reserva incrementa antes do `create`, então um erro ali consome o número; é o comportamento seguro (nunca reusar), e o buraco que sobra agora tem destino: `GET /fiscal/inutilizacoes/pendentes/:establishmentId` o encontra sozinho e a inutilização o regulariza. O número perdido daquele 409 — NF-e série 1 nº 1 — foi inutilizado de verdade, protocolo `131260152624931`
