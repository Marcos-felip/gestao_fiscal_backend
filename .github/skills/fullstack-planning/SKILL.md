...
- Preservar a linha `- Frontend: \`...\`` em `.github/copilot-instructions.md`.
- Usar `FRONTEND_COPILOT_INSTRUCTIONS_PATH` no `.env` como fonte da referencia do frontend.
- Em caso de alteracao de path, rodar `npm run sync:copilot-instructions`.
